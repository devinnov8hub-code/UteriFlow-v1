...
// Detect the live URL automatically
const PROD_URL = process.env.VERCEL_URL
  ? `https://${process.env.VERCEL_URL}/api/v1`      // Vercel injects this automatically
  : process.env.API_URL
    ? `${process.env.API_URL}/api/v1`                // fallback custom env var
    : null;
